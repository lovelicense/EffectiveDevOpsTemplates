    ...
    PolicyDocument=Policy(
        ...
        Statement=[
            Statement(
                Action=[PutObject],
                Effect=Allow,
                Principal=Principal("AWS", ["582318560864"]),
                Resource=[Join('',
                               [ARN(''),
                                Ref("S3Bucket"),
                                   "/AWSLogs/574844118613/*"])],
            )
        ]
    )
))
...
t.add_resource(Alarm(
    ...
    AlarmActions=["arn:aws:sns:ap-northeast-1:574844118613:alert-emails"],
    OKActions=["arn:aws:sns:ap-northeast-1:574844118613:alert-email"],
...
t.add_resource(Alarm(
    ...
    Threshold="0.5",
    ComparisonOperator="GreaterThanOrEqualToThreshold",
    AlarmActions=["arn:aws:sns:ap-northeast-1:574844118613:alert-email"],
    OKActions=["arn:aws:sns:ap-northeast-1:574844118613:alert-email"],
    InsufficientDataActions=[],
))
print(t.to_json())
